    ...
    internal partial class MainForm : Form
    {
        ...
        private void AddAccount(WalletAccount account, bool selected = false)
        {
            ...
            if (item == null)
            {
                ...
                item = listView1.Items.Add(new ListViewItem(new[]
                {
                    ...
                    new ListViewItem.ListViewSubItem
                    {
                        Name = NativeContract.DVITA.Symbol
                    },
                    new ListViewItem.ListViewSubItem
                    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            foreach (UInt160 assetId in NEP5Watched)
            {
                ...
                string symbol = null;
                if (assetId.Equals(NativeContract.DVITA.Hash))
                    symbol = NativeContract.DVITA.Symbol;
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
        {
            ...
            voteToolStripMenuItem.Enabled =
                listView1.SelectedIndices.Count == 1 &&
                !((WalletAccount)listView1.SelectedItems[0].Tag).WatchOnly &&
                !string.IsNullOrEmpty(listView1.SelectedItems[0].SubItems[NativeContract.DVITA.Symbol].Text) &&
                decimal.Parse(listView1.SelectedItems[0].SubItems[NativeContract.DVITA.Symbol].Text) > 0;
